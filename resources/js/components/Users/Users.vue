            ...
            if (this.validateData()) {
                this.$store
                    ...
                    .then((response) => {
                        this.$store.dispatch('user/getUsers');
                        this.closeModal();
                        this.$refs.flashMessage.showMessage('User was created !!', 'alert-success');
                    })
            }
        },
            ...
            if (this.validateData()) {
                this.$store
                    ...
                    .then((response) => {
                        this.$store.dispatch('user/getUsers');
                        this.closeModal();
                        this.$refs.flashMessage.showMessage('User was Updated !!', 'alert-success');
                    });
            }
        },
        // delete User
            ...
            if (confirm("Are you sure you want to delete user!")) {
                this.$store
                    ...
                    .then((response) => {
                        this.$store.dispatch('user/getUsers');
                        this.closeModal();
                        this.$refs.flashMessage.showMessage('User was Deleted !!', 'alert-success');
                    });
            }
        },
